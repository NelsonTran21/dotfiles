...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [COLEMAK_LAYER] = LAYOUT_ortho_5x12( \
    ...
    KC_LCTL, KC_LGUI, KC_LALT, MIRROR, KC_NO,   KC_SPC,  KC_NO,   SYMBOL,  LAMBDA,  KC_SLCK, KC_RGUI, KC_RCTL
  ),

  [QWERTY_LAYER] = LAYOUT_ortho_5x12(
    KC_ESC,  KC_1,    KC_2,    KC_3,   KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
    ...
    KC_LCTL, KC_LGUI, KC_LALT, MIRROR, KC_NO,   KC_SPC,  KC_NO,   SYMBOL,  LAMBDA,  KC_RALT, KC_RGUI, KC_RCTL
  ),

  [SYMBOL_LAYER] = LAYOUT_ortho_5x12(
  ...
  [NUMPAD_LAYER] = LAYOUT_ortho_5x12(
  ...
  [FUNCTION_LAYER] = LAYOUT_ortho_5x12(
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______,
